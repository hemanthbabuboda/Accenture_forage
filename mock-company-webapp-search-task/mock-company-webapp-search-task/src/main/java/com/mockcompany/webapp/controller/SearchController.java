...
public class SearchController {
    ...
    public Collection<ProductItem> search(@RequestParam("query") String query) {
        ...
        for (ProductItem item : allItems) {
	        ...
	        String lowerDescription = item.getDescription().toLowerCase();

	        boolean matchesSearch;
	        if (exactMatch) {
	            matchesSearch = lowerName.equals(lowerQuery) || lowerDescription.equals(lowerQuery);
	        } else {
	            matchesSearch = lowerName.contains(lowerQuery) || lowerDescription.contains(lowerQuery);
	        }
